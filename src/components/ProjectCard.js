  ...
  return (
    ...
    >
      <img
        ...
        alt=""
        onClick={handleClick}
        className="lg:grayscale object-cover transition-transform duration-[400ms] ease-out  group-hover:lg:scale-105 group-hover:lg:grayscale-0"
      />
      <div
        onClick={handleClickMobile}
        className="transition-all absolute -bottom-5 z-10 flex h-0 w-full flex-col items-center justify-center overflow-hidden bg-gray-100 lg:bg-pink-global  p-4 opacity-90 duration-500 ease-in-out group-hover:bottom-0 group-hover:h-full group-hover:opacity-80 lg:cursor-default lg:justify-normal group-hover:lg:h-[100px]"
      >
