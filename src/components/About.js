...
const About = () => {
  return (
    ...
    >
      <div className="my-24 md:flex md:gap-8 lg:my-32 lg:gap-12 pt-[3rem]">
        <div className="content-about">
          <motion.h1
            ...
            viewport={{ once: true }}
          >
            Je suis Ibtisamath, développeuse web passionnée.
          </motion.h1>
          ...
          >
            ...
            <p className="pt-3 text-sm leading-6 text-gray-darkest lg:text-[1rem]">
              ...
              <span className="inline-block pt-1 leading-4 text-gray-darkest shadow-[inset_0px_-6px_0px] shadow-pink-ultra-light">
                React,
              </span>{" "}
              <span className="inline-block pt-1 leading-4 text-gray-darkest shadow-[inset_0px_-6px_0px] shadow-pink-ultra-light">
                Sass
